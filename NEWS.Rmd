...
This document provides a history of changes, updates, and improvements made to the `pasagropasr` package.
...
- Provides access to the `lambBreeds` dataset, containing lamb carcass measurements and tissue composition categorized by breed.
- Includes basic functionality for dataset exploration and visualization.
...
- Initial conceptualization and development of the `pasagropasr` package.
...
- For the latest development version, visit the GitHub repository:
 [https://github.com/PAS-AGRO-PAS/pasagropasr/](https://github.com/PAS-AGRO-PAS/pasagropasr/)
